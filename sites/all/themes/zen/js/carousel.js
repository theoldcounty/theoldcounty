									...
									if(data!=null){
										...
										jQuery.each(data, function(key, value) { 
											...
											*/
											...
											var hiddenData = '<div class="hiddenPane"><div class="corner"></div><div class="title"><a href="'+path+'">'+title+'</a></div><div class="subhead">'+subhead+'</div><div class="tags">'+tagHtml+'</div><div class="body">'+body+'</div></div>';
