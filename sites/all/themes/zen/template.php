...
function getSizeThumb($vid){
	...
	class service{
		function callSerice($type){
			global $base_url;

			if($type == "home"){
				$serviceLink = "sites/all/modules/custom/mixedcarousel/mixed.php";
			}

			if($type == "studio"){
				$serviceLink = "sites/all/modules/custom/mixedcarousel/studio.php";
			}

			$curlUrl = $base_url."/".$serviceLink;
			//print_r($curlUrl);
		...
		function generateHtml($type){
			...
			foreach ($results as $key => $value) {
				...
				if($type == "studio"){
					...
					$html.='<div class="views-row views-row-'.$rowId.' '.$thumbSize.'"><div class="revealedPane"><img src="'.$imgSrc.'"></div><div class="hiddenPane"><div class="title">'.$title.'</div><div class="jobtitle">'.$jobtitle.'</div><div class="body">'.$body.'</div></div></div>';
				}
				else{
					...
					$html.='<div class="views-row views-row-'.$rowId.' '.$thumbSize.'"><div class="revealedPane"><img src="'.$imgSrc.'"></div><div class="hiddenPane"><div class="title">'.$title.'</div><div class="subhead">'.$subhead.'</div><div class="tags">'.$tagHtml.'</div><div class="body">'.$body.'</div></div></div>';
				}
